...
public class DecisonTree {
	...
	public static void main(String[] args) {
		...
		try {
			...
			BufferedReader reader = new BufferedReader(new FileReader("train-3.dat"));//training file
			...
			BufferedReader reader1 = new BufferedReader(new FileReader("test-3.dat"));//testing file
